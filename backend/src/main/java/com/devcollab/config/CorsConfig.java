...
/**
 * CORS for the Next.js dev client. Origins are read from {@code app.cors.allowed-origins}
 * (comma-separated). Credentials are allowed so the httpOnly auth cookie flows.
 */
@Configuration
